  ...
  Widget build(BuildContext context) {
    ...
    return profileAsync.when(
      ...
      data: (profile) {
        ...
        final authUid =
            ref.read(firebaseAuthProvider).currentUser?.uid ?? profile.uid;
        ...
        final pages = isParent
            ...
            : [
                StudentHomeScreen(studentId: authUid),
                const AiTutorScreen(),
                PracticeScreen(studentId: authUid),
              ];
        ...
        return Scaffold(
          appBar: AppBar(
            ...
            actions: [
              if (!isParent) _NotificationBell(studentId: authUid),
              IconButton(
                tooltip: 'Settings',
